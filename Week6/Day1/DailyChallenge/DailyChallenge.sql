...
DELETE FROM actors WHERE first_name = 'Angelina' AND last_name = 'Pery';
SELECT * FROM actors
...
INSERT INTO actors(first_name,date_of_birth,oscars)
VALUES('Tom','03/07/1965', 6);
-- The query will fail with an error, because we are trying to insert an empty value.
